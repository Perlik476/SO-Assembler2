...
TESTS="so_emulator_example_mov.c so_emulator_example_mul.c so_emulator_example_multi_core_inc.c correctness_random.cpp"
...
echo ""
echo "Każdy test powinien działać poniżej 5 sekund."
